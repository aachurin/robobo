...
class AppFrame(wx.Frame):
    ...
    def init_ui(self):
        ...
        vbox1 = wx.BoxSizer(wx.VERTICAL)
        hbox1 = wx.BoxSizer(wx.HORIZONTAL)
        label = wx.StaticText(panel, label="Max force", size=(80, -1), style=wx.ALIGN_RIGHT)
        label.SetFont(font)
        hbox1.Add(label)
        self.max_force_spin = wx.SpinCtrl(panel, size=(100, -1), min=0, max=50000000, value=str(config.get("arena:max-force")))
        ...
        vbox1.Add(hbox1)
        hbox1 = wx.BoxSizer(wx.HORIZONTAL)
        label = wx.StaticText(panel, label="Run count", size=(80, -1), style=wx.ALIGN_RIGHT)
        label.SetFont(font)
        hbox1.Add(label)
        self.run_count_spin = wx.SpinCtrl(panel, size=(100, -1), min=1, max=99, value=str(config.get("arena:run-count")))
